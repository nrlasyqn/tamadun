                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        gradient: LinearGradient(
                            colors: [Color.fromRGBO(207, 191, 148, 1.0),Color.fromRGBO(207, 191, 148, 1.0),],
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: RaisedButton(
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>TimelineHomosapiens()));
                            },
                        ...
                        child: RaisedButton(
                            ...
                            child: Ink(
                              ...
                              child: Container(
                                constraints: BoxConstraints(maxWidth: 300.0, minHeight: 50.0),
                                alignment: Alignment.center,
                                child: Text( "${snapshot.data!['topic-4']}",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(fontSize: 16.0,
                                    fontFamily: 'PoppinsMedium',
                                    color: Colors.black,),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>living_things()));
                        },
                      ),
                    ],
                  ),
